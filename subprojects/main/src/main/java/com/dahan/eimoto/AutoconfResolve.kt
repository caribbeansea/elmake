...
import com.dahan.eimoto.dsl.AbsMake
...
object AutoconfResolve {
    ...
    fun doBuilding(base_dir: String) {
        ...
        val stream = Streams.getResourceAsStream("com/dahan/eimoto/${conf_name}.tmp", this::class.java.classLoader)
    ...
    fun main(args: Array<String>) {
        doBuilding("/Users/wuyanzu/project/IdeaProjects/eimoto/debugging")
    }
