package com.dahan.eimoto.collect;
...
public final class Arrays {
     ...
     * @param src    原数组
     * @param dist   目标数组
     * @param offset 从哪个位置开始拷贝
     */
    public static <T> void copyOf(T[] src, T[] dist, int offset) {
        System.arraycopy(src, offset, dist, 0, dist.length);
    }
